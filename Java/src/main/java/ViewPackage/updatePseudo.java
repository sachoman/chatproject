...
public class updatePseudo {
	public updatePseudo() {
		JFrame frame = new JFrame("Changement pseudo");
	     ...
	     JLabel title = new JLabel("Changement du pseudo");
	   	 	gbc.gridx = 1;
	   	 	gbc.gridy = 0;
	   	 	gbc.gridwidth = 3;
	   	 	gbc.gridheight = 1;
	 	...
	 	frame.add(title,gbc);
	   	 	JTextArea message = new JTextArea("Indiquez le nouveau pseudo que vous souhaitez utiliser");
